    ...
    .directive('euRegionMap', [function () {
        ...
        function link(scope, element, attr) {
            ...
            function RegionOut(object) {
                var nuts=angular.element(object).attr("nuts"),el = element.find("path"),i,reg;
            ...
            function RegionOver(object, e) {
                var nuts=angular.element(object).attr("nuts");
                var el = element.find("path");
            
            
                for (var i = 0; i < el.length; i+=1) {
                    var reg=el[i].getAttribute("nuts")                    
                    if(reg==nuts){
            ...
            function SetDataArray(list, range) {
                ...
                for (var i = 0; i < mapping.length; i += 3) {
                    ...
                    SetRegionColor(mapping[i + 2], "#aaaaaa");
                }
            ...
            function settingsChanged() {
                ...
                var newData = [];
                var dataObject,i,e,curObj,lau,dataObj1,dataObj2,titleText;
            ...
            for (i = 0; i < el.length; i+=1) {
                if(el[i].getAttribute("ignore")!=1){
                    reg=el[i].getAttribute("region");
                    el[i].setAttribute("nuts", reg);
